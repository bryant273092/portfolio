            ...
            <FlexColumn margin={'50px 0px '} width={'100%'} aligned={'center'}>
                <RenderBox>
                    ...
                    <JobContainer selected={thirdBtn}>
                        <FlexRow>
                            <FlexColumn width={'100%'}  >
                                <SectionHeading padding={'0px 0px 0px 10px'} size={'clamp(20px, 4vw, 30px)'} color={'#1DA1F2'}>Commercify LLC</SectionHeading>
                                <ContentRow aligned={'left'}>
                                    <SectionHeading padding={'0px 0px 0px 10px'} size={'clamp(15px, 3vw, 25px)'}>{data.Experience["Commercify LLC"].title}</SectionHeading>
                                    <SectionHeading padding={'0px 0px 0px 10px'} size={'clamp(15px, 3vw, 25px)'} color={'#8892b0'}>( Jun 2018 - Current )</SectionHeading>
                                </ContentRow>
                                <ContentRow margin={'50px 0px 0px 0px'}>
                                    <FlexColumn width={'100%'}>
                                        <Text top={'0px'} width={'100%'} color={'#8892b0'} >
                                            {data.Experience["Commercify LLC"].description}
                                        </Text>
                                    </FlexColumn>
                                    <FlexColumn margin={'0px 0px 0px 0px'} aligned={'center'} >
                                        <Image src={'/commercify.webp'} />
                                        <Button onClick={() => {
